...
# Modifications: Marc Gantenbein, Paul Fischer
# This software is licensed under the Apache License 2.0

from matplotlib import use
import torch
import torch.nn as nn
from models.punet.src.unet import Unet
from models.punet.src.utils import init_weights, init_weights_orthogonal_normal
from torch.distributions import Normal, Independent, kl
import numpy as np
from models.punet.src.utils import l2_regularisation
...
class AxisAlignedConvGaussian(nn.Module):
    ...
    def forward(self, input, segm=None):
        ...
        # print('In AxisAligned-Class: dimension of encoded one-hot representation:', encoding.shape)
...
class ProbabilisticUnet(nn.Module):
    ...
    def elbo(self, segm, analytic_kl=False, reconstruct_posterior_mean=False):
        ...
        return -(self.reconstruction_loss + 0.01 * self.kl_divergence_loss)
    ...
    def make_prediction(self, img): 
        ...
        samples = []
        for i in range(20):
            out = self.forward(img, training=False)
